...
//$billid = $_SESSION['bill'];
    ...
    $query = "SELECT * FROM `bill` WHERE `bid`='".$_SESSION['bill']."'";
    $result = mysqli_query($conn, $query);
    $billtoshow = mysqli_fetch_assoc($result);
    //$eid = $billtoshow['eid'];
    $type = $billtoshow['type'];
    $describe = $billtoshow['description'];
    $amount = $billtoshow['amt'];
...
<div class="row">
  ...
  <div class="main">
    <h1>BILL DETAILS</h1>
    Bill ID: <b><?php echo $_SESSION['bill']; ?></b><br/>
    Submitted by: <b><?php echo $_SESSION['submi_by']; ?></b><br/>
    Amount: <b><?php echo $amount; ?></b><br/>
    Description: <b><?php echo $describe; ?></b><br/>
    Type: <b><?php echo $type; ?></b><br/>
    Status: <b><?php echo $status; ?></b><br/>
    <div class="fakeimg"><!--img src="Dollar.jpg" style="width: 100%; height: 100%"--></div>
  </div>
