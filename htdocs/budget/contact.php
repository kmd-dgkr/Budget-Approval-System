...
<div class="row">
  ...
  <div class="main">
    <h3 style="align:right; padding: 2em; padding-top: 0px; padding-bottom: 0px;">Developers:</h3>
    <pre style="font-family: Sans Serif; font-size: 18px; ">
		G. Kaumudi
		K. Sreeja Reddy
		Aashritha Malyala
		V. Sai Rachana</pre>

    <h3 style="align:right; padding: 2em; padding-top: 0px; padding-bottom: 0px;">Reach us out here:</h3>

    <pre style="font-family: Sans Serif; font-size: 18px; ">
                 9876543210
                 budgetapproval@gmail.com</pre>
