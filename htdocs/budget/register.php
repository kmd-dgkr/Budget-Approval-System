...
<div class="row">
  ...
  <div class="main">
    ...
    <div class="imgcontainer">
      ...
      <p align= "center">Please choose your role:</p> <br>
      <button type="submit" onclick="location.href= 'registemp.php';">Employee</button>
      <button type="submit" onclick="location.href= 'registmgr.php';">Manager</button>
